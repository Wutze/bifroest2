...
$FW -A $rulename -i $DEV_LAN1 -o $DEV_DMZ1 -j ACCEPT            ## -> DMZ
...
$FW -A $rulename -i $DEV_LAN1 -o $DEV_LAN1 -s 10.10.10.61 -p udp -m multiport --dport 53 -j ACCEPT            ## DNS UDP
...
$FW -A $rulename -i $DEV_LAN1 -o $DEV_INTERN -s 10.10.10.52 -d $DNS_INTERN1 -j ACCEPT		## Alex PS4
$FW -A $rulename -i $DEV_LAN1 -o $DEV_INTERN -s 10.10.10.52 -d $DNS_INTERN2 -j ACCEPT		## Alex PS4
...
$FW -A $rulename -i $DEV_LAN1 -o $DEV_INTERN -s 10.10.10.54 -d $DNS_INTERN1 -j ACCEPT		## Alex PC2
$FW -A $rulename -i $DEV_LAN1 -o $DEV_INTERN -s 10.10.10.54 -d $DNS_INTERN2 -j ACCEPT		## Alex PC2
$FW -A $rulename -i $DEV_LAN1 -o $DEV_DMZ1 -s 10.10.10.54 -j ACCEPT		## Alex PC2


$FW -A $rulename -i $DEV_LAN1 -o $DEV_EXTERN -s 10.10.10.11 -d $DNS1 -p tcp -m multiport --dport 53 -j ACCEPT            ## DNS2
$FW -A $rulename -i $DEV_LAN1 -o $DEV_EXTERN -s 10.10.10.11 -d $DNS2 -p tcp -m multiport --dport 53 -j ACCEPT            ## DNS2
$FW -A $rulename -i $DEV_LAN1 -o $DEV_EXTERN -s 10.10.10.11 -d $DNS3 -p tcp -m multiport --dport 53 -j ACCEPT            ## DNS2
$FW -A $rulename -i $DEV_LAN1 -o $DEV_EXTERN -s 10.10.10.11 -d $DNS1 -p udp -m multiport --dport 53 -j ACCEPT            ## DNS2
